...
import { Phone, MapPin, GraduationCap, BadgeCheck, Heart, Sparkles, Mail, ExternalLink, Calendar, ChevronRight } from "lucide-react";
      ...
      <div className="flex flex-col md:flex-row gap-12 items-center md:items-start">
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="flex flex-wrap gap-4 pt-2">
            ...
            <a href="https://mlopezdev.netlify.app/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2 rounded-lg border border-border bg-card text-muted-foreground hover:text-purple-400 hover:border-purple-500/50 transition-all duration-300 text-sm">
